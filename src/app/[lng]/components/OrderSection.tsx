import Timeline from "@/app/[lng]/components/Timeline"; // Assuming .tsx or adjust if needed
    ...
    return (
        <div className="md:w-1/2 w-full">
            ...
            <div className="mb-6 space-y-4">
                <div>
                    <label htmlFor="name"
                           className="block text-sm font-medium text-gray-700 mb-1">{t("order_view.order.name")}</label>
                    <input
                        id="name"
                        name="name"
                        type="text"
