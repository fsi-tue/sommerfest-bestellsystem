        ...
        <div className="bg-white p-8 rounded-2xl shadow-md mb-8">
            ...
            <div className="flex flex-col items-center p-4 rounded-2xl shadow-md">
                ...
                <div className="flex space-x-4">
                    <Link href="/"
                          className="bg-primary-950 text-white px-4 py-2 rounded-2xl mt-4 w-full md:w-auto hover:bg-primary-800">Order
                        again</Link>
                    <Link href="/order/list"
                          className="bg-primary-950 text-white px-4 py-2 rounded-2xl mt-4 w-full md:w-auto hover:bg-primary-800">View
                        orders</Link>
                </div>
            </div>
        </div>
