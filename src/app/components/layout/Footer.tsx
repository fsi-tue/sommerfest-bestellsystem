        ...
        >
            ...
            <p>
                Copyright © {currentYear} <a href="https://www.fsi.uni-tuebingen.de"
                                             className="font-medium text-indigo-600 hover:underline">Fachschaft
                Informatik
                Tübingen</a>
                <span className="mx-1">|</span>Pizza-fueled code by <a href="https://github.com/Zeilenschubser/"
                                                                       className="font-medium text-indigo-600 hover:underline">Zeilenschubser</a> & <a
                href="https://github.com/am9zZWY" className="font-medium text-indigo-600 hover:underline">Josef
                Müller</a>
            </p>
        </footer>
    );
