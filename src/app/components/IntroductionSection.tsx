                ...
                <ol className="list-none space-y-6">
                    <li className="flex flex-col md:flex-row md:items-baseline gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-lg font-bold text-gray-900">{t('order_view.introduction.choose_your_item')}</p>
                        </div>
                    </li>
                    <li className="flex flex-col md:flex-row md:items-baseline gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-lg font-bold text-gray-900">{t('order_view.introduction.pick_up_time')}</p>
                        </div>
                    </li>
                    <li className="flex flex-col md:flex-row md:items-baseline gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-lg font-bold text-gray-900">{t('order_view.introduction.pay_in_cash')}</p>
                        </div>
                    </li>
                </ol>
                <p className="mt-8 text-center text-xl font-medium text-gray-800 pt-4 border-t border-gray-100">
                    {t('order_view.introduction.closer')}
                </p>
            </div>
        </div>
    );
